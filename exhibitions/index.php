...
<head>
  ...
  <!-- <link href="https://fonts.googleapis.com/css?family=Dosis:200,600|Roboto:500" rel="stylesheet">  -->
  <style>
    /* latin */
    @font-face {
    font-family: 'Dosis';
...
<body>
  ...
  <main class="exhibitions">
    ...
    <p><strong>* currently accepting submissions *</strong></p>

    <h2>Rules to Play By — call for entries</h2>
